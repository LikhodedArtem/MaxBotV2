...
class PayloadMixin(BaseModel):
    ...
    @classmethod
    def check_inner(cls, v: str | tuple[str] | None | Inner) -> Inner:
...
class Inner(BaseModel):
    ...
    Attributes:
        value: на входе принимает str | tuple[str] | None, итого хранит tuple[str]
    ...
    @classmethod
    def prepare_value(cls, v: str | tuple[str] | None) -> tuple[str, ...]:
        ...
        raise ValueError("Передан неправильный формат данных для Inner")
